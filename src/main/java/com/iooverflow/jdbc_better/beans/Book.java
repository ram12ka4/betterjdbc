...
public class Book {
	...
	public String toString() {
		/* @formatter:off */
		return new StringBuilder("Book [").append("id=").append(id).append(", title=").append(title)
				.append(", authours=").append(authours).append(", edition=").append(edition).append(", isbn10=")
				.append(isbn10).append(", isbn13=").append(isbn13).append(", publisher=").append(publisher)
				.append(", publishingDate=").append(publishingDate).append("]").toString();
		/* @formatter:on */
	}
}
